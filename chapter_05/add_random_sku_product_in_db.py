...
# from chapter_05.add_random_brand_in_db import load_common_words
...
def gen_products(common_words: List[str],
    ...
    products = [] # All product beforce insert in db.
    for _ in range(products_to_create):
        description = [common_words[index] for index in sample(range(1000), 10)] # Give element
